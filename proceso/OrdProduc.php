    ...
    <td width="840" align="center" valign="middle"><div class="cont">
      <form id="ordcompra" name="ordcompra" method="post" action="">
        <table width="820px" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td colspan="5" align="center" bgcolor="#999999"><h1>Orden de Producción</h1></td>
          </tr>
          <tr>
            <td width="186">Id de Orden de Produccion</td>
...
?>
                ...
                <td><select name="OrdProdIDPRODUCTO" id="OrdProdIDPRODUCTO">
                  <?php
do {  
?>
                  <option value="<?php echo $row_SELECTPRODUCTO['IDPRODUCTO']?>"<?php if (!(strcmp($row_SELECTPRODUCTO['IDPRODUCTO'], $row_SELECTPRODUCTO['DESCRIPCIONPRODUC']))) {echo "selected=\"selected\"";} ?>><?php echo $row_SELECTPRODUCTO['DESCRIPCIONPRODUC']?></option>
      ...
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center">
          <tr valign="baseline">
            ...
            <td><input type="text" name="IDORDENPRODUCCION" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">IDENCABEORDPROD:</td>
            <td><input type="text" name="IDENCABEORDPROD" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">CANTIDADORPROD:</td>
            <td><input type="text" name="CANTIDADORPROD" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">ID_MEDIDA:</td>
            <td><input type="text" name="ID_MEDIDA" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">PRODUCTOORDPRODUC:</td>
            <td><input type="text" name="PRODUCTOORDPRODUC" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">FECHAHORAUSUA:</td>
            <td><input type="text" name="FECHAHORAUSUA" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
