...
do {  
?>
              <option value="<?php echo $row_MEDIDA['ID_MEDIDA']?>"<?php if (!(strcmp($row_MEDIDA['ID_MEDIDA'], $row_MEDIDA['MEDIDA']))) {echo "selected=\"selected\"";} ?>><?php echo $row_MEDIDA['MEDIDA']?></option>
              <?php
