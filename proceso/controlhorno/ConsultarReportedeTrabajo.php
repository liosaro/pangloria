<?php require_once('file:///G|/Connections/basepangloria.php'); ?>
<?php
...
<script src="file:///G|/SpryAssets/SpryValidationTextField.js" type="text/javascript"></script>
<link href="file:///G|/SpryAssets/SpryValidationTextField.css" rel="stylesheet" type="text/css" />
</head>
    ...
    <td bgcolor="#CCCCCC"><form id="form1" name="form1" method="post" action="">
      ...
      <form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
        <table width="100%" border="0">
          <tr>
            <td colspan="4" align="center" bgcolor="#CCCCCC"><h1>Modificar Control de Productos en Horno</h1></td>
          </tr>
          <tr>
            <td width="20%" height="28" align="center">Codigo Control de Producto en Horno</td>
          ...
          <tr>
            <td align="center" bgcolor="#CCCCCC"><strong>Cantidad que Ingresa:</strong></td>
            <td align="center" bgcolor="#CCCCCC"><strong>Cantidad que Egresa:</strong></td>
