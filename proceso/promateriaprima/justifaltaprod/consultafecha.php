...
$query_fecha = sprintf("SELECT * FROM TRNJUSTIFICACIONFALTAPRODUCTO WHERE FECHAINGRESOJUSFAPROD LIKE %s ORDER BY FECHAINGRESOJUSFAPROD DESC", GetSQLValueString("%" . $colname_fecha . "%", "date"));
...
<table border="1">
  ...
  <?php do { ?>
    <tr>
      <td><?php echo $row_fecha['ID_JUSTIFICACION']; ?></td>
      <td><?php echo $row_fecha['IDCONTROLPRODUCCION']; ?></td>
      <td><?php echo $row_fecha['CANTIDA_FALTANTE']; ?></td>
      <td><?php echo $row_fecha['IDPRODUCTOFALTA']; ?></td>
      <td><?php echo $row_fecha['ID_MEDIDA']; ?></td>
      <td><?php echo $row_fecha['FECHAINGRESOJUSFAPROD']; ?></td>
      <td><?php echo $row_fecha['JUSTIFICACIONFALTAPROD']; ?></td>
    </tr>
