    ...
    <td width="840" align="center" valign="middle"><div class="cont">
      <form id="ordcompra" name="ordcompra" method="post" action="">
        <table width="820px" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td colspan="5" align="center" bgcolor="#999999"><h1>Consultar Pedido de Materia Prima</h1></td>
          </tr>
          <tr>
            <td>Seleccione tipo de Consulta</td>
            <td><label for="IDPRODUCTO">
              <input type="radio" name="radio" id="id" value="id" />
              Numero de Pedido</label></td>
            <td>&nbsp;</td>
...
?>
          ...
          <tr>
            <td>&nbsp;</td>
            <td><input type="radio" name="radio" id="id4" value="id" />
...
?>
          ...
          <tr>
            ...
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td><input type="submit" name="SEND2" id="SEND2" value="Consultar" />
              <input type="reset" name="add" id="add" value="Limpiar" /></td>
          </tr>
          <tr>
            <td width="186">&nbsp;</td>
            <td width="188">&nbsp;</td>
