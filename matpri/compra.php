      ...
      <tr>
        <td><div class="tope" id="admin2tope">
          <ul id="MenuBar1" class="MenuBarHorizontal">
            ...
            <img src="../forms/imagenes/icono/Time.png" width="35" height="35" />
          </ul>
        </div>
              ...
              <tr>
                <td><div class="usuario" id="user1">
                  <table width="204,8" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td align="center" valign="bottom"><img src="../forms/imagenes/icono/Man_Red_256.png" width="45" height="45" /><img src="../forms/imagenes/icono/Supervisor-256.png" width="45" height="45" /><img src="../forms/imagenes/icono/Judge-256.png" width="45" height="45" alt="Consultar Empleados" /></td>
                    </tr>
                    <tr>
                ...
                <table width="204,8" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td align="center" valign="bottom"><img src="../forms/imagenes/icono/shopping_cart_128.png" width="45" height="45" /><img src="../forms/imagenes/icono/Shopping-cart-256.png" width="45" height="45" /><img src="../forms/imagenes/icono/Red-Wallet-256.png" width="45" height="45" /></td>
                    </tr>
                    <tr>
                ...
                <table width="204,8" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td align="center" valign="bottom"><img src="../forms/imagenes/icono/Invoice-256.png" width="45" height="45" /><img src="../forms/imagenes/icono/Safe-256.png" width="45" height="45" /><img src="../forms/imagenes/icono/Cash-register-256.png" width="45" height="45" /></td>
                    </tr>
                    <tr>
                ...
                <table width="204,8" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td align="center" valign="bottom"><img src="../forms/imagenes/icono/Delivery-Truck.png" width="45" height="45" /><img src="../forms/imagenes/icono/Card-file.png" width="45" height="45" /><img src="../forms/imagenes/icono/Time.png" width="45" height="45" /></td>
                    </tr>
                    <tr>
                ...
                <table width="204,8" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td align="center" valign="bottom"><img src="../forms/imagenes/icono/Banana-128.png" width="45" height="45" /><img src="../forms/imagenes/icono/Breakfast-Box-128.png" width="45" height="45" /><img src="../forms/imagenes/icono/Compurter-256.png" width="45" height="45" /></td>
                    </tr>
                    <tr>
  ...
  <tr>
    ...
    <td width="840" align="center"><div class="cont">
      <table width="820px" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="5" align="center" bgcolor="#999999"><h1>Compra</h1></td>
          </tr>
        <tr>
          <td width="136">ID de compra</td>
          <td width="238"><label for="idcompra"></label>
            <input type="text" name="idcompra" id="idcompra" /></td>
          <td width="43">&nbsp;</td>
          <td width="231">Orden Que genera la compra</td>
          <td width="172"><input type="text" name="idcompra2" id="idcompra2" /></td>
        </tr>
        <tr>
          <td>Proveedor</td>
          <td><label for="idproveedor"></label>
        ...
        <tr>
          <td>Estado</td>
          <td><select name="idproveedor3" id="idproveedor3">
        ...
        <tr>
          <td>No factura Referencia</td>
          <td><input type="text" name="idcompra4" id="idcompra4" /></td>
          <td>&nbsp;</td>
          <td>Orden aprovada por</td>
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>Compra realizada por</td>
          <td><select name="idproveedor5" id="idproveedor5">
            <option value="1">Francisco Javier Flores</option>
          </select></td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="5" bgcolor="#999999"><div align="center">DETALLE</div></td>
        </tr>
        <tr>
          <td colspan="5"><table width="820%" border="1" cellspacing="0" cellpadding="0">
            <tr>
              <th bgcolor="#999999" scope="col">Cantidad</th>
              <th bgcolor="#999999" scope="col">Articulo</th>
              <th bgcolor="#999999" scope="col">Unidad</th>
              <th bgcolor="#999999" scope="col"><p>Precio Unitario</p></th>
              <th bgcolor="#999999" scope="col">Precio Total</th>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              <td colspan="4" align="right" bgcolor="#999999">Descuento</td>
            ...
            <tr>
              <td colspan="4" align="right" bgcolor="#999999">IVA</td>
              <td bgcolor="#999999">&nbsp;</td>
            </tr>
            <tr>
        ...
        <tr>
          <td><input type="submit" name="add" id="add" value="Agregar" />
            <input type="submit" name="add2" id="add2" value="Quitar" /></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
