...
/**
 * MySQL API for PHP Report Maker 2+
 ...
 */
$PHPReportMaker_vers = 'v2.0.0 PHP Report Maker (C) 2007-2008 e.World Technology Limited';
...
class ADOConnection
{
	...
	function Version()
	{
		global $PHPReportMaker_vers;
		return (float) substr($PHPReportMaker_vers,1);
	}
