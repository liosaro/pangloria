  ...
  <tr>
    ...
    <td width="840" align="center"><div class="cont">
      <table width="820px" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="5" align="center" bgcolor="#006CA7"><h1>Empleado</h1></td>
          </tr>
        <tr>
          <td width="136">ID de empleado</td>
          <td width="238" align="left"><label for="idcompra2"></label>
            <input type="text" name="idcompra" id="idcompra2" /></td>
          <td width="43">&nbsp;</td>
          <td width="216">No Seguro</td>
          <td width="187" align="left"><input type="text" name="idcompra2" id="idcompra" /></td>
        </tr>
        <tr>
          <td>Nombre Completo</td>
          <td align="left"><label for="idproveedor">
            <input type="text" name="idcompra7" id="idcompra6" />
          </label></td>
          <td>&nbsp;</td>
          <td>DUI</td>
          <td align="left"><input type="text" name="date4" id="date5" /></td>
        </tr>
        <tr>
          <td>Edad</td>
          <td align="left"><input type="text" name="idcompra8" id="idcompra7" /></td>
          <td>&nbsp;</td>
          <td>Cuenta Bancaria</td>
          <td align="left"><input type="text" name="idcompra3" id="date" />            <img src="../imagenes/icono/Time.png" alt="" width="20" height="20" /></td>
        </tr>
        <tr>
          <td>Direccion</td>
          <td align="left"><input type="text" name="idcompra4" id="idcompra4" /></td>
          <td>&nbsp;</td>
          <td>Correo</td>
          <td align="left"><input type="text" name="date3" id="date4" /></td>
        </tr>
        <tr>
          <td>NIT</td>
          <td align="left"><input type="text" name="idcompra5" id="idcompra3" /></td>
          <td>&nbsp;</td>
          <td>Telefono Movil</td>
          <td align="left"><input type="text" name="date2" id="date3" /></td>
        </tr>
        <tr>
          <td>NUP</td>
          <td><input type="text" name="idcompra6" id="idcompra5" /></td>
          <td>&nbsp;</td>
          <td>Telefono Fijo</td>
          <td><input type="text" name="date" id="date2" /></td>
        </tr>
        <tr>
          <td>Departamento</td>
          <td><select name="idproveedor6" id="idproveedor6">
            <option value="1">Produccion</option>
            <option value="2">Administracion</option>
          </select></td>
          <td>&nbsp;</td>
          <td>Cargo</td>
          <td><select name="idproveedor7" id="idproveedor7">
            <option value="1">Panadero</option>
            <option value="2">Bodeguero</option>
          </select></td>
        </tr>
        <tr>
          <td><img src="../imagenes/icono/Newspaper_Feed_add_32x32.png" width="32" height="32" /><img src="../imagenes/icono/delete-32.png" alt="" width="32" height="32" /></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>Sucursal</td>
        ...
        <tr>
          <td><img src="../imagenes/icono/Backward-32.png" width="32" height="32" /><img src="../imagenes/icono/Back-32.png" alt="" width="32" height="32" /><img src="../imagenes/icono/Next-32.png" width="32" height="32" /><img src="../imagenes/icono/Forward-32.png" width="32" height="32" /></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td align="right">Buscar empleado </td>
          <td align="left"><input type="text" name="date5" id="date6" />
            <img src="../imagenes/icono/3D-Search-32.png" alt="" width="22" height="22" /></td>
        </tr>
      </table>
    </div></td>
  </tr>
