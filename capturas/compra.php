  ...
  <tr>
    ...
    <td width="840" align="center"><div class="cont">
      <table width="820px" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="4" align="center" bgcolor="#006CA7"><h1>Compras</h1></td>
          <td width="187" align="center" bgcolor="#006CA7">&nbsp;</td>
        </tr>
        <tr>
          ...
          <td width="43">&nbsp;</td>
          <td width="216">Orden Que genera la compra</td>
          <td align="left"><input type="text" name="idcompra2" id="idcompra" /></td>
        </tr>
        <tr>
          <td>Proveedor</td>
          <td align="left"><label for="idproveedor"></label>
            <select name="idproveedor" id="idproveedor">
              <option value="1">Julio Cesar Flores</option>
            </select></td>
          <td>&nbsp;</td>
          <td>Concepto</td>
          <td align="left"><select name="idproveedor4" id="idproveedor4">
        ...
        <tr>
          <td>Estado</td>
          <td align="left"><select name="idproveedor3" id="idproveedor3">
        ...
        <tr>
          ...
          <td align="left"><select name="idproveedor2" id="idproveedor2">
        ...
        <tr>
          ...
          <td align="left"><select name="idproveedor5" id="idproveedor5">
            <option value="1">Francisco Javier Flores</option>
          </select></td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="5" bgcolor="#006CA7"><div align="center">DETALLE</div></td>
        </tr>
        <tr>
          <td colspan="5"><table width="820px" border="1" cellspacing="0" cellpadding="0">
            <tr>
              <th bgcolor="#E8E8E8" scope="col">Cantidad</th>
              <th bgcolor="#E8E8E8" scope="col">Articulo</th>
              <th bgcolor="#E8E8E8" scope="col">Unidad</th>
              <th bgcolor="#E8E8E8" scope="col"><p>Precio Unitario</p></th>
              <th bgcolor="#EEEEEE" scope="col">Precio Total</th>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr>
              <td colspan="4" align="right" bgcolor="#E8E8E8">Descuento</td>
            ...
            <tr>
              <td colspan="4" align="right" bgcolor="#E8E8E8">IVA</td>
              <td bgcolor="#E8E8E8">&nbsp;</td>
            </tr>
            <tr>
