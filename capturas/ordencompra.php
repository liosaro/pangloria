  ...
  <tr>
    <td width="184" bgcolor="#006CA7"><div class="menuiz" id="menuizquierdo">
      <div id="Accordion1" class="Accordion" tabindex="0">
        ...
        <div class="AccordionPanel">
          ...
          <div class="AccordionPanelContent">
            <p><a href="compra.php">Ingresar Compra</a></p>
    ...
    <td width="840" align="center"><div class="cont">
      <table width="820px" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="5" align="center" bgcolor="#006CA7"><h1>Orden de Compras</h1></td>
          </tr>
        <tr>
          <td width="136">ID de Orden </td>
          <td width="238" align="left"><label for="idcompra2"></label>
            <input type="text" name="idcompra" id="idcompra2" /></td>
          <td width="43">&nbsp;</td>
          <td width="216">Detalle de orden</td>
        ...
        <tr>
          ...
          <td align="left"><input type="text" name="date" id="date2" />
            <img src="../imagenes/icono/Time.png" alt="" width="20" height="20" /></td>
        </tr>
        <tr>
          <td>Estado</td>
        ...
        <tr>
          <td><input type="submit" name="add" id="add" value="Modificar Detalle" /></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
