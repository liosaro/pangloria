...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      <td colspan="2" align="center" nowrap="nowrap" bgcolor="#999999"><h1>Modificar Proveedor</h1></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">NOMBRE DEL PROVEEDOR:</td>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">DIRECCION DEL PROVEEDOR:</td>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">FECHA DE INGRESO DELPROVEEDOR:</td>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">DEPTO.PAIS DEL PROVEEDOR:</td>
