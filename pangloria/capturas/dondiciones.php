  ...
  <tr>
    ...
    <td width="840" align="center"><div class="cont">
      <table width="423" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td colspan="2" align="center" bgcolor="#003399"><h1>Condiciones de pago</h1></td>
        </tr>
        <tr>
          <td width="178">ID de condicion</td>
          <td width="245"><form id="form1" name="form1" method="post" action="">
            <label for="idcantidad"></label>
        ...
        <tr>
          ...
          <td><form id="form2" name="form2" method="post" action="">
            ...
            <input type="text" name="idcantidad2" id="idcantidad2" />
          </form></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
