...
$query_id = sprintf("SELECT * FROM CATUSUARIO WHERE IDUSUARIO = %s ORDER BY IDUSUARIO ASC", GetSQLValueString($colname_id, "int"));
...
<table border="1">
  ...
  <?php do { ?>
    <tr>
      <td><?php echo $row_id['IDUSUARIO']; ?></td>
      <td><?php echo $row_id['NOMBREUSUARIO']; ?></td>
      <td><?php echo $row_id['CONTRASENA']; ?></td>
      <td><?php echo $row_id['PRIMERINICIO']; ?></td>
      <td><?php echo $row_id['ULTIMOINICIO']; ?></td>
    </tr>
