...
$query_nombre = sprintf("SELECT * FROM CATUSUARIO WHERE NOMBREUSUARIO LIKE %s ORDER BY IDUSUARIO ASC", GetSQLValueString("%" . $colname_nombre . "%", "text"));
...
<table border="1">
  ...
  <?php do { ?>
    <tr>
      <td><?php echo $row_nombre['IDUSUARIO']; ?></td>
      <td><?php echo $row_nombre['NOMBREUSUARIO']; ?></td>
      <td><?php echo $row_nombre['CONTRASENA']; ?></td>
      <td><?php echo $row_nombre['PRIMERINICIO']; ?></td>
      <td><?php echo $row_nombre['ULTIMOINICIO']; ?></td>
    </tr>
