...
$query_conatribu = sprintf("SELECT * FROM CATATRIBUCIONES WHERE IDROL = %s", GetSQLValueString($colname_conatribu, "int"));
...
<table border="1" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="8" bgcolor="#999999">Detalle de Consulta de Atribucion por Rol</td>
  </tr>
  <tr>
